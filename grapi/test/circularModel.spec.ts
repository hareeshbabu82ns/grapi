/**
 * ManyToMany Circular for simple CRUD tests
 */
import chai from 'chai'
import chaiHttp = require( 'chai-http' );
chai.use( chaiHttp )

import { sdl, testSuits } from './testsuites/circularModel'
import { createGrapiApp, MongodbDataSourceGroup, prepareConfig } from './testsuites/utils'

const { mongoUri } = prepareConfig()

describe( 'Tests on fixtures/circularModel.graphql with MongoDB Data Source', function() {
    this.timeout( 20000 )
